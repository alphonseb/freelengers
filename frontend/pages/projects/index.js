...
export default function Projects() {
  ...
  const recommandedProject = projects[0];
  projects.splice(0, 1);
        ...
        <>
          <div className='project-recommanded'>
            ...
            <div className='project'>
              <p className='subtitle'>{recommandedProject.name}</p>
              ...
              <p className='paragraph'>
                Nous souhaiton faire intervenir une équipe de freelengers sur la
                refonte complète de notre site vitrine. Nous voulons donner un
                coup de boost à notre business par la création d’une expérience
                utilisateur forte et une direction artistique en accord avec nos
                valeurs.
              </p>
              <button
          ...
          <div className='projects-list'>
            {projects.map((project, id) => (
              <div key={id} className='project'>
                ...
                <p className='paragraph'>
                  Nous souhaiton faire intervenir une équipe de freelengers sur
                  la refonte complète de notre site vitrine. Nous voulons donner
                  un coup de boost à notre business par la création d’une
                  expérience utilisateur forte et une direction artistique en
